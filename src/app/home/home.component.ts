...
export class HomeComponent implements OnInit {
  ...
  user_name: any;
  constructor(private fb: FormBuilder, private http: HttpClient,public dialog: MatDialog,private route :Router) {
  ...
  ngOnInit() {
    ...
    this.http.get("http:///182.72.104.66:5790//api/v1/machines?tenant_id=" + this.sample_test.tenant_id, headers).subscribe(res => {
      console.log(res);
      // console.log(filName);
...
// http://52.66.140.40
    ...
    // this.http.get("http:///52.66.140.40/api/v1/file_path?id=" + machine_id, headers).subscribe(res => {
      console.log(machine_id)
       this.http.get("http://182.72.104.66:5790//api/v1/file_path?id=" + machine_id, headers).subscribe(res => {
      //console.log(res);
      // alert(res.status);
      // alert(res.file_path);
      // alert(res['status'])
  ...
  logintest(val) {
    ...
    //    console.log(res);
       this.http.post("http://182.72.104.66:5790//api/v1/file_move", fd, { headers: { Authorization: "Bearer " + localStorage.getItem("token") } }).subscribe(resp => {
      console.log(resp);
      alert(resp['status'])
      this.ngOnInit();
